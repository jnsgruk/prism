...
export type HandlerRun = Message<"canonical.prism.v1.HandlerRun"> & {
  ...
  /**
   * Pipeline that triggered this run, if any.
   *
   * @generated from field: optional string pipeline_id = 11;
   */
...
export type GetPipelineStatusResponse = Message<"canonical.prism.v1.GetPipelineStatusResponse"> & {
   ...
   */
  current?: PipelineInfo | undefined;
 ...
 */
export type ListPipelineRunsResponse = Message<"canonical.prism.v1.ListPipelineRunsResponse"> & {
  /**
   * @generated from field: repeated canonical.prism.v1.PipelineRunSummary pipelines = 1;
   */
 ...
 *
 * @generated from message canonical.prism.v1.PipelineRunSummary
 */
export type PipelineRunSummary = Message<"canonical.prism.v1.PipelineRunSummary"> & {
  /**
   * @generated from field: canonical.prism.v1.PipelineInfo pipeline = 1;
   */
  pipeline?: PipelineInfo | undefined;

  /**
   * Handler runs linked to this pipeline, ordered by started_at ASC.
   *
   * @generated from field: repeated canonical.prism.v1.HandlerRun runs = 2;
   */
  runs: HandlerRun[];
};
