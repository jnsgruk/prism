...
export const PrismLogo = ({ className, size = 24 }: PrismLogoProps): React.ReactElement => (
  <svg width={size} height={size} viewBox="0 0 512 512" fill="none" className={cn(className)} aria-hidden="true">
    ...
    <polygon points="48,225 423,225 456,256 423,287 48,287" fill="#5AD87A" />
    <polygon points="48,291 418,291 352,353 48,353" fill="#4DA6FF" />
    <polygon points="48,357 348,357 281,419 48,419" fill="#8B8AFF" />
    <polygon points="48,423 277,423 210,485 48,485" fill="#CF7EF0" />
  </svg>
);
