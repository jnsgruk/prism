...
export const OrgInsightsSummary = ({
  insights,
}: {
  ...
  const hasAnyData = hasReviewData || hasSignificanceData || hasTopicData;
    ...
    <TooltipProvider>
      <Card>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              ...
              {hasReviewData && rq && (
                <div className="space-y-4 lg:col-span-2">
                  <h3 className="text-sm font-medium">Review Culture</h3>
              ...
              {/* Right column: PR Impact + Discourse + Coverage */}
          ...
          {/* Depth x Significance cross-reference */}
          {hasDbs && dbs && (
            <div className="space-y-3">
